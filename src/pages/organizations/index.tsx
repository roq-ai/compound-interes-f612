...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'compound_interest.count', 'customer_request.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('compound_interest', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'compound_interest',
          header: 'Compound Interest',
          accessorKey: 'compound_interest',
          cell: ({ row: { original: record } }: any) => record?._count?.compound_interest,
        }
      : null,
    hasAccess('customer_request', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'customer_request',
          cell: ({ row: { original: record } }: any) => record?._count?.customer_request,
        }
      : null,
