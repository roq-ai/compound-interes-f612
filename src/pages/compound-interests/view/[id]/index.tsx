...
import { getCompoundInterestById } from 'apiSdk/compound-interests';
import { CompoundInterestInterface } from 'interfaces/compound-interest';

function CompoundInterestViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Compound Interest Details',
              isCurrent: true,
            },
          ]}
        />
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Time Period" text={data?.time_period} />

                <FormListItem label="Compounding Frequency" text={data?.compounding_frequency} />
